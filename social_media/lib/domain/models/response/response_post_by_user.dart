...
ResponsePostByUser responsePostByUserFromJson(String str) =>
    ResponsePostByUser.fromJson(json.decode(str));

String responsePostByUserToJson(ResponsePostByUser data) =>
...
class ResponsePostByUser {
  ...
  factory ResponsePostByUser.fromJson(Map<String, dynamic> json) =>
      ResponsePostByUser(
        resp: json["resp"],
        message: json["message"],
        postUser: List<PostUser>.from(
            json["postUser"].map((x) => PostUser.fromJson(x))),
      );
