...
ResponseListMessages responseListMessagesFromJson(String str) =>
    ResponseListMessages.fromJson(json.decode(str));
...
class ResponseListMessages {
  ...
  factory ResponseListMessages.fromJson(Map<String, dynamic> json) =>
      ResponseListMessages(
        resp: json["resp"],
        message: json["message"],
        listMessage: List<ListMessage>.from(
            json["listMessage"].map((x) => ListMessage.fromJson(x))),
      );
