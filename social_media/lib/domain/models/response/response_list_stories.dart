...
String responseListStoriesToJson(ResponseListStories data) =>
...
class ResponseListStories {
  ...
  factory ResponseListStories.fromJson(Map<String, dynamic> json) =>
      ResponseListStories(
        resp: json["resp"],
        message: json["message"],
        listStories: List<ListStory>.from(
            json["listStories"].map((x) => ListStory.fromJson(x))),
      );
