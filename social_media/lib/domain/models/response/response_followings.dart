...
ResponseFollowings responseFollowingsFromJson(String str) =>
    ResponseFollowings.fromJson(json.decode(str));

String responseFollowingsToJson(ResponseFollowings data) =>
...
class ResponseFollowings {
  ...
  factory ResponseFollowings.fromJson(Map<String, dynamic> json) =>
      ResponseFollowings(
        resp: json["resp"],
        message: json["message"],
        followings: List<Following>.from(
