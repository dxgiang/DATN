...
ResponsePostProfile responsePostProfileFromJson(String str) =>
    ResponsePostProfile.fromJson(json.decode(str));

String responsePostProfileToJson(ResponsePostProfile data) =>
...
class ResponsePostProfile {
  ...
  factory ResponsePostProfile.fromJson(Map<String, dynamic> json) =>
      ResponsePostProfile(
        resp: json["resp"],
        message: json["message"],
        post: List<PostProfile>.from(
            json["post"].map((x) => PostProfile.fromJson(x))),
      );
