...
ResponsePostSaved responsePostSavedFromJson(String str) =>
    ResponsePostSaved.fromJson(json.decode(str));

String responsePostSavedToJson(ResponsePostSaved data) =>
...
class ResponsePostSaved {
  ...
  factory ResponsePostSaved.fromJson(Map<String, dynamic> json) =>
      ResponsePostSaved(
        resp: json["resp"],
        message: json["message"],
        listSavedPost: List<ListSavedPost>.from(
            json["listSavedPost"].map((x) => ListSavedPost.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "message": message,
        "listSavedPost":
            List<dynamic>.from(listSavedPost.map((x) => x.toJson())),
      };
}
