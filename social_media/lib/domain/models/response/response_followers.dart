...
ResponseFollowers responseFollowersFromJson(String str) =>
    ResponseFollowers.fromJson(json.decode(str));

String responseFollowersToJson(ResponseFollowers data) =>
...
class ResponseFollowers {
  ...
  factory ResponseFollowers.fromJson(Map<String, dynamic> json) =>
      ResponseFollowers(
        resp: json["resp"],
