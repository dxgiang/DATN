...
ResponseListChat responseListChatFromJson(String str) =>
    ResponseListChat.fromJson(json.decode(str));

String responseListChatToJson(ResponseListChat data) =>
...
class ResponseListChat {
  ...
  factory ResponseListChat.fromJson(Map<String, dynamic> json) =>
      ResponseListChat(
        resp: json["resp"],
        message: json["message"],
        listChat: List<ListChat>.from(
            json["listChat"].map((x) => ListChat.fromJson(x))),
      );
