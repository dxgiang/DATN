...
class StoryServices {
  Future<DefaultResponse> addNewStory(String image) async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('${Environment.urlApi}/story/create-new-story'))
  ...
  Future<List<StoryHome>> getAllStoriesHome() async {
    ...
    final resp = await http.get(
        Uri.parse('${Environment.urlApi}/story/get-all-stories-home'),
  ...
  Future<List<ListStory>> getStoryByUSer(String uidStory) async {
    ...
    final resp = await http.get(
        Uri.parse('${Environment.urlApi}/story/get-story-by-user/' + uidStory),
        headers: {'Accept': 'application/json', 'xxx-token': token!});
